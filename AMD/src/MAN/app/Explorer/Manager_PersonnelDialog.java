...
public class Manager_PersonnelDialog extends JDialog{
...
//	private final Dao dao = Dao.getInstance();
	...
	public static void main(String args[]) {
		try {
			Manager_PersonnelDialog dialog = new Manager_PersonnelDialog("", "", -1);
					...
					if (field.getType().equals(JTextField.class)) {
						...
						try {
							textField = (JTextField) field
									.get(Manager_PersonnelDialog.this);
						} catch (Exception e1) {
							e1.printStackTrace();
						}
